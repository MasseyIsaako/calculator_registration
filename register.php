<?php
    ...
    if($_POST) {
        ...
        echo "No form input detected. Please write something into the input field.";
    }
...
<?php require "assets/templates/header.php"; ?>
    ...
    <div id="register">
        ...
        <form method="POST" action="register.php" id="register-form" autocomplete="on">
            ...
            <div class="row">
                <div class="form-group col">
                    ...
                    <input type="text" name="firstname" class="form-control" id="firstname-input" aria-describedby="firstnameHelp" placeholder="Type . . . " value="<?php if (isset($firstname)) {echo $firstname;} else { echo ""; } ?>" autofocus>
                </div>
                <div class="form-group col">
                    <label for="lastname" class="font-white required-field">* Last Name</label>
                    <input type="text" name="lastname" class="form-control" id="lastname-input" aria-describedby="lastnameHelp" placeholder="Type . . . " value="<?php if (isset($lastname)) {echo $lastname;} else { echo ""; } ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col">
                    ...
                    <input type="number" name="phonenumber" class="form-control" id="phone-input" aria-describedby="phoneHelp" placeholder="Type . . . " value="<?php if (isset($phonenumber)) {echo $phonenumber;} else { echo ""; } ?>">
                </div>
                <div class="form-group col">
                    <label for="housenumber" class="font-white required-field">* Home Address Number</label>
                    <input type="number" name="housenumber" class="form-control" id="house-input" aria-describedby="houseHelp" placeholder="Type . . . " value="<?php if (isset($housenumber)) {echo $housenumber;} else { echo ""; } ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col">
                    ...
                    <input type="email" name="email" class="form-control" id="email-input" aria-describedby="emailHelp" placeholder="Type . . . " value="<?php if (isset($email)) {echo $email;} else {echo "";} ?>">
                </div>
            </div>
